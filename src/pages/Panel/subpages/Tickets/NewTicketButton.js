...
function NewTicketButton() {
    return (
        <div className="w-full md:w-4/12 xl:w-3/12 p-3 " >
            <div className=' w-full text-white rounded-xl gap-3 inline-flex items-center justify-center  lg:justify-start p-2 bg-green-500 hover:bg-green-600 hover:cursor-pointer'>

  ...
  useEffect(()=> {
    ...
    return (
        <div className='input-group flex flex-col gap-2 text-xs p-0 justify-start mt-3'>
            ...
            <textarea  cols="30" type={otherProps.type} {...otherProps} onChange={(event) => { onChangeEvent(event) }} onBlur={onFocusHandler} focused={onFocused.toString()} className='bg-slate-50 p-3 rounded-lg outline-none leading-6' ></textarea>

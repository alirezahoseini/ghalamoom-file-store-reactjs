...
// assets
import enamadLogo from '../../assets/images/logos/enamad.png'
import zarinPalLogo from '../../assets/images/logos/zarinpal.svg'
                ...
                <div id="footer-wrapper" className='flex flex-col lg:flex-row lg:items-start justify-evenly'>
                    ...
                    <section id='contact-links' className='p-6 lg:w-4/12'>
                        ...
                        <div id='trust-logos' className='flex items-center justify-around mt-5'>
                            <img src={zarinPalLogo}alt="zarinpal logo" />
                            <img src={enamadLogo} alt="enamad logo" className='w-28' />
                        </div>
                    </section>
